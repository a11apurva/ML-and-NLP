...
print(model.summary())
history = model.fit(padded_docs, one_hot_labels, epochs=8, verbose=1 , validation_split=0.2)
...
text1= ["GAGIGHAJ HHDFFFJB FDAGDEAI GGDIJHGC BCCJJAII FIFFHEHB DABEDIEH FGFDAFIE GCHHCHHE EGDFJFCB",
        "EDEGFHAH FICADDEA IFBHEFB CFGJCDAI JEBEGJFA HJGDAEE IGEJIFDH DCEEBDG CFFDBDEF CHJIHFBI",
        "DGHEGGGA JHDHEIH BEHBFBED BFFGFCGH BAGJGFJB JEBEGJFA HJGDAEE JDAAFDFI CHJIHFBI IDJBCFAI",
        "HIHDIJJF BHBAJHIA JDCFIEH IIBAJCFA BGADIIHI HAFDHBAB EDICFIEC JHDHEIH BEHBFBED BFFGFCGH",
        "BEHBFBED BFFGFCGH BAGJGFJB JEBEGJFA HJGDAEE CFFDBDEF CHJIHFBI IDJBCFAI"]

#vocabulary_size = 200000
#tokenizer = Tokenizer(num_words= vocabulary_size)
#tokenizer.fit_on_texts(df['text'])
sequences = t.texts_to_sequences(text1)
